            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="lastname" class="col-md-4 col-form-label text-md-end">Apellido(s)</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="rol" id="rol">
                                    <option value='Elegir' {{old('rol') ? '' : 'selected'}}>Seleccione una opcion</option>
                                    <option value='Administrador' {{old('rol') == 'Administrador' ? 'selected' : ''}}>Administrador</option>
                                    <option value='Medico' {{old('rol') == 'Medico' ? 'selected' : ''}}>Medico</option>
                        ...
                        <div class="row mb-3">
                            <label for="gender" class="col-md-4 col-form-label text-md-end">Genero</label>
